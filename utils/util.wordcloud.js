...
module.exports = () => {
    return new function () {
        ...
        this.drawWordcload = async (words, imageShape, options) => {
            ...
            let canvas = createCanvas(defaultOptions.width ? Number.parseInt(defaultOptions.width) : 800, defaultOptions.height ? Number.parseInt(defaultOptions.height) : 600)
        ...
        this.segment = text => {
            ...
            words.forEach(word => {
                ...
                if (0x01000000 == word.p || 0x00800000 == word.p
                    || 0x00100000 == word.p || 0x00004000 == word.p
                    || 0x00000080 == word.p || 0x00000040 == word.p
                    || 0x00000020 == word.p || 0x00000008 == word.p
                    || 0x00000001 == word.p) {
